...
class IdControllerWidget {
    ...
    private readonly ifaFirstPartyCookieName = "id_controller_ifa";
    ...
    private addSetCookieEventListener(): void {
        ...
        const evtListener = (event: MessageEvent) => {
            ...
            if (data.ifa) {
                ...
                IdControllerWidget.setCookieString(this.ifaFirstPartyCookieName, data.ifa, expires, this.originHost, document);
            }
        }
